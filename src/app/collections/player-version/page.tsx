...
export default function PlayerVersionPage() {
  const [loading, setLoading] = useState(true);
  const [products, setProducts] = useState<any[]>([]);
  const collectionContent = getCollectionContent('player-version');
      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="container mx-auto px-6 py-12">
          ...
          {loading ? (
            ...
            <ProductList initialProducts={products} collection="player-version" />
          )}
