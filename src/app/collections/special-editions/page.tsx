...
export default function SpecialEditionsPage() {
  ...
  const collectionName = collectionContent?.h1 || 'Special Editions';
  
  const breadcrumbItems = [
    { name: 'Home', url: baseUrl },
    { name: collectionName, url: `${baseUrl}/collections/special-editions` },
      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="container mx-auto px-6 py-12">
          ...
          {loading ? (
            ...
            <ProductList initialProducts={products} collection="special-editions" />
          )}
